...
public class TreeCreationUtils {
  ...
  public static IntegerLiteralTree integerLiteral(String value) {
    return integerLiteral(value, null);
  }
  ...
  public static NativeTree simpleNative(NativeKind kind, List<Tree> children, TextRange textRange, String ... tokens) {
    return new NativeTreeImpl(metaData(textRange, tokens), kind, children);
  }
  ...
  private static TreeMetaData metaData(TextRange textRange, String ... tokens) {
    return metaData(Arrays.asList(tokens), textRange);
  }

  private static TreeMetaData metaData(List<String> tokens, TextRange textRange) {
